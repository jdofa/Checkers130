...
$sql = "INSERT INTO LocalBoard (Username, Password, LocalName, GamesPlayed, GamesWon, TimePlayed) VALUES ('$username', '$password', '$player1', 1, 0, '$timePlayed')";
...
$sql = "INSERT INTO LocalBoard (Username, Password, LocalName, GamesPlayed, GamesWon, TimePlayed) VALUES ('$username', '$password', '$player2', 1, 1, '$timePlayed')";
if ($conn->query($sql) === FALSE) {
    echo "Error Inserting Record: " . $conn->error;
    $error = TRUE;
}

// Alter GlobalBoard - GamesPlayed + 1, TimePlayed + time played in game
